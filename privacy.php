...
<head>
	<title>Ceronics Online Store - Privacy Notice</title>
	<meta charset="utf-8">
...
<ol>
    <li>
        ...
        Welcome to <span> Ceronics</span>.<br>
        <span>Ceronics</span> (“us”, “we”, or “our”) operates <span>cosmicarts.tech</span> (hereinafter referred to as <span>“Service”</span>).<br>
        Our Privacy Policy governs your visit to <span>cosmicarts.tech</span>, and explains how we collect, safeguard and disclose information that results from your use of our Service.<br>
        ...
        Our Terms and Conditions (<span>“Terms”</span>) govern all use of our Service and together with the Privacy Policy constitutes your agreement with us (<span>“agreement”</span>).<br>
    </li>
    <li><span>Definitions</span><br>
        <ol>
            <li><span>SERVICE</span> means the cosmicarts.tech website operated by Ceronics.</li>
            <li><span>PERSONAL DATA</span> means data about a living individual who can be identified from those data (or from those and other information either in our possession or likely to come into our possession).</li>
            <li><span>USAGE DATA</span> is data collected automatically either generated by the use of Service or from Service infrastructure itself (for example, the duration of a page visit).</li>
            <li><span>COOKIES</span> are small files stored on your device (computer or mobile device).</li>
            <li><span>DATA CONTROLLER</span> means a natural or legal person who (either alone or jointly or in common with other persons) determines the purposes for which and the manner in which any personal data are, or are to be, processed. For the purpose of this Privacy Policy, we are a Data Controller of your data.</li>
            <li><span>DATA PROCESSORS (OR SERVICE PROVIDERS)</span> means any natural or legal person who processes the data on behalf of the Data Controller. We may use the services of various Service Providers in order to process your data more effectively.</li> 
            <li><span>DATA SUBJECT</span> is any living individual who is the subject of Personal Data.</li>
            <li><span>THE USER</span> is the individual using our Service. The User corresponds to the Data Subject, who is the subject of Personal Data.</li>
        </ol>
    </li>
    <li>
        <span>Information Collection and Use</span><br>
        We collect several different types of information for various purposes to provide and improve our Service to you.<br>
    </li>
    <li><span>Types of Data Collected</span>
        <ul>
            <li><span>Personal Data</span><br>
                While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you (<span>“Personal Data”</span>). Personally identifiable information may include, but is not limited to:
                <ul>
                    <li>Email address</li>
            ...
            <li>
                ...
                We may also collect information that your browser sends whenever you visit our Service or when you access Service by or through any device (<span>“Usage Data”</span>).<br>
            ...
            <li><span>Location Data</span><br>
                We may use and store information about your location if you give us permission to do so (<span>“Location Data”</span>). We use this data to provide features of our Service, to improve and customize our Service.<br>You can enable or disable location services when you use our Service at any time by way of your device settings.<br>
            </li>
            <li>
                <span>Tracking Cookies Data</span><br>
                ...
                <ul>
                    ...
                    <li><span>Advertising Cookies:</span> Advertising Cookies are used to serve you with advertisements that may be relevant to you and your interests.</li>
                    <li><span>Other Data</span><br>
                        While using our Service, we may also collect the following information: sex, age, date of birth, place of birth, passport details, citizenship, registration at place of residence and actual address, telephone number (work, mobile), details of documents on education, qualification, professional training, employment agreements, non-disclosure agreements, information on bonuses and compensation, information on marital status, family members, social security (or other taxpayer identification) number, office location and other data.</li>
                </ul>
            </li>
        </ul>
    </li>
    <li>
        <span>Use of Data</span><br>
        Ceronics uses the collected data for various purposes:
        <ul>
    ...
    <li>
        <span>Retention of Data</span><br>
    ...
    <li>
        ...
        If you are located outside Malaysia and choose to provide information to us, please note that we transfer the data, including Personal Data, to Malaysia and process it there.<br>
    ...
    <li>
        ...
        <ol>
            ...
            <li><span>Other cases. We may disclose your information also:</span>
                <ul>
    ...
    <li>
        <span>Service Providers</span><br>
        We may employ third party companies and individuals to facilitate our Service (<span>“Service Providers”</span>), provide Service on our behalf, perform Service-related services or assist us in analysing how our Service is used.<br>
    ...
    <li>
        <span>Children’s Privacy</span><br>
        Our Services are not intended for use by children under the age of 18 (<span>“Child”</span> or <span>“Children”</span>).<br>
    ...
    <li>
        ...
        If you have any questions about this Privacy Policy, please contact us by email: <span>ceronics2020@gmail.com</span>.
    </li>
</ol>
